document.addEventListener('DOMContentLoaded', () => {
  ...
  // Draw the computer ships in random locaion
  ...
  function dragDrop() {
    ...
    const notAllowedVertical = [
      ...
      81, 80, 79, 78, 77, 76, 75, 74, 73, 72, 71, 70, 69, 68, 67, 65, 64, 63,
      62, 61, 60,
    ];
  ...
  function checkForWins() {
    ...
    if (carrierCount === 5) {
      infoDisplay.innerHTML = 'You sunk the computers carrie';
      carrierCount = 10;
    }
